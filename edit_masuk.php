    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <form   method="post" name='edit'>
          ...
          <input class="form-control" type="date" name='tanggal' value="<?php echo $d['tanggal']; ?>" placeholder="Tanggal Masuk..." required>
...
$edit = mysqli_query($conn, "UPDATE masuk SET tanggal='$tanggal',nama_barang ='$nama_barang',kode_barang ='$kode_barang',jumlah_barang ='$jumlah_barang' WHERE id ='$id".$_GET['id']."'
");
