      ...
      <div id="content">
        ...
        <div class="container-fluid">
                  ...
                  if($ggl){
                    ...
                    $det=mysqli_query($conn, "select * from stock where id='$id_brg'")or die(mysql_error());
          ...
          <?php
           ...
           <div class="col-md-3">
           <a href="tab_stock.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
           </div>
