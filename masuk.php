  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
              <center><h5 class="mb-5"><b>Input Barang Masuk</b></h5></center>
    ...
    <?php
     ...
     $jumlah_barang = htmlspecialchars($_POST['jumlah_barang']);
             ...
             $wet =mysqli_query($conn, "select * from masuk where tanggal ='$tanggal' and kode_barang ='$kode_barang' and nama_barang='$nama_barang'");
