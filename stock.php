  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
              <center><h5 class="mb-5"><b>Input Data Stock</b></h5></center>
              ...
              <div class="row mt-3">
                <div class="col-sm-4">
                  ...
                  <input class="form-control form-control-sm" type="text" placeholder="Nama Barang..." aria-label=".form-control-sm example" name='nama_barang' required>
                </div>
              </div>
              ...
              <div class="row mt-3">
                <div class="col-sm-4">
                 <label>Kode Barang:</label>
                   <input class="form-control form-control-sm" type="text" placeholder="Kode Barang..." aria-label=".form-control-sm example" name='kode_barang' required>
                </div>
              </div>
              ...
              <input class="form-control form-control-sm" type="number" placeholder="Jumlah Barang..." aria-label=".form-control-sm example" name='jumlah_barang' required>
              </div>
              </div>
    ...
    <?php
     ...
     $jumlah_barang = htmlspecialchars($_POST['jumlah_barang']);
             ...
             $wet =mysqli_query($conn, "select * from stock where kode_barang ='$kode_barang' and nama_barang='$nama_barang'");
             $chak = mysqli_num_rows($wet);
             if($chak > 0){

               $rew = mysqli_fetch_array($wet);
              
               $nama_barang === $rew['nama_barang'];
               $kode_barang === $rew['kode_barang'];
     ...
     $insert = mysqli_query($conn, "INSERT INTO stock VALUES (
      NULL,
      '$nama_barang',
      '$kode_barang',
      '$jumlah_barang'
