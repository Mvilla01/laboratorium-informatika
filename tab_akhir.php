  ...
  <div id="wrapper">
   ...
   <h6 class="m-0 font-weight-bold text-primary">Data Stock Barang:</h6>
                ...
                <div class="card-body">
                  ...
                  $jumlah_cos=mysqli_query($conn,"SELECT COUNT(*) as id from stock");
...
if(isset($_GET['hapus'])){
   ...
   echo "</div>";
                   ...
                   if(isset($_GET['cari'])){
                    ...
                    $brg=mysqli_query($conn, "select * from stock where id like '%".$cari."%' or nama_barang like '%".$cari."%' ");
                 ...
                 if(mysqli_num_rows($brg) > 0){
                    ...
                    $brg=mysqli_query($conn, "select * from stock orders limit $start, $hal");
                  }
                 ...
                 if(mysqli_num_rows($brg)){
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>&nbsp;<a href="edit_stock.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> 
                       &nbsp; <a href="hapus_stock.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> 
                       &nbsp; <a href="detail_stock.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
