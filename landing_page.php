      ...
      <div class="container">
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav">
                      <!-- ***** Logo Start ***** -->
                      <a href="#" class="logo">Sistem Informasi Alat Laboratorium Informatika</a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                      <img src="img/uad.png" class="rounded img-fluid d-block mx-auto" alt="First Vector Graphic">
                  </div>
              </div>
          </div>
      </div>
