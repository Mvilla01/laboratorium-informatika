      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
            ...
            $det=mysqli_query($conn, "select * from stock where id='$id_brg'");
...
$edit = mysqli_query($conn, "UPDATE stock SET nama_barang ='$nama_barang',kode_barang ='$kode_barang',jumlah_barang ='$jumlah_barang'
WHERE id ='$id".$_GET['id']."'
");
