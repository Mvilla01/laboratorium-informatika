    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <form   method="post" name='edit'>
          ...
          <input class="form-control" type="date" name='tanggal' value="<?php echo $d['tanggal']; ?>" placeholder="Tanggal keluar..." required>

          <P><b>Nama Barang:</b></p>
          <input class="form-control" type="text" name='nama_barang' value="<?php echo $d['nama_barang']; ?>" placeholder="Nama Barang..." required>

          <P><b>Kode Barang:</b></p>
          <input class="form-control" type="text" name='kode_barang' value="<?php echo $d['kode_barang']; ?>" placeholder="Kode Barang..." required>

          <P><b>Jumlah Barang:</b></p>
          <input class="form-control" type="text" name='jumlah_barang' value="<?php echo $d['jumlah_barang']; ?>" placeholder="Jumlah Barang..." required>
...
$edit = mysqli_query($conn, "UPDATE keluar SET tanggal='$tanggal',nama_barang ='$nama_barang',kode_barang ='$kode_barang',jumlah_barang ='$jumlah_barang' WHERE id ='$id".$_GET['id']."'
");
